<header>
    ...
    <div class="row pb-4">
    <div
      class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 herosection-wrapper d-lg-flex d-xl-flex flex-column-reverse flex-lg-row flex-xl-row align-items-xl-center pb-1">
      ...
      <div class="col-1 col-sm-1 col-md-1 col-lg-2 col-xl-3">
        <img class="img-fluid" src="Images/fond-blanc.png" alt="">
      </div>
            ...
            <nav class="col-12 d-flex p-0">
                <div class="col-9 d-flex p-0">
                    <ul class="d-flex align-items-center h-100">
                        ...
                        <li><a class="navbar-link" href="/stage/index.html">La Bio ICI</a></li>
