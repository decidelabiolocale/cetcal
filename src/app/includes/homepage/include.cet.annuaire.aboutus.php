<section>
    <div class="row d-xl-flex justify-content-xl-center aboutus--bg">
        <div class="col-12 col-xl-3 d-flex justify-content-center align-items-center">
            <img class="w-75 w-xl-auto mw-100" src="res/content/images-site/qui-sommes-nous.png" alt="Max-width 100%" >
        </div>
    </div>
    <div class="row d-flex justify-content-center mb-5">
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-4 d-flex flex-column text-aboutus">
            ...
            <p>▸ Créer du lien, de la solidarité et de l'entraide entre producteurs, entre
                producteurs et consommateurs, avec les collectivités locales engagées, les
                associations, les chercheurs...
            </p>
            <h6>Decidelabiolocale.org</h6>
            <p>
                À partir de ces priorités nous avons mis en place une plateforme
                numérique financée par le Conseil régional de Nouvelle Aquitaine et l'Europe.
            </p>
            <h6>Cet plateforme a un double objectif :</h6>
            <p>▸ Être exhaustive, en présentant gratuitement tout les producteurs BIO et
                y tendant qui le souhaitent, dans un rayon de 40 km autour de Castillon la
                Bataille.<span>En savoir plus sur le BIO et les producteurs y tendant</span></p>
            <p>
                ▸ Être construite à partir des besoins et attentes des producteurs. Le questionnaire ci-dessous va nous permettre de recueillir ces informations qui nous permettront
                de valoriser leur ferme, leur travail et de connaître leurs attentes
            </p>
        </div>
    </div>
    <div class="row">
